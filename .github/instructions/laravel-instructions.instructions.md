---
description: This file provides comprehensive coding standards and best practices for Laravel 12 projects using PHP 8.2/8.4, guiding Copilot to generate high-quality, maintainable, and secure code.
applyTo: **/*.php
---
...
The current project is using `internachi/modular` package for modular architecture. All modules are located in the `modules` directory, and each module follows a standard structure:
