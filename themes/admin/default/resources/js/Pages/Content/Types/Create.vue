    ...
    <AdminLayout>
        <div class="space-y-4">
            <div>
                ...
                <p class="text-sm text-slate-600">Build schema visually with drag-drop. Save will queue migration execution.</p>
            </div>
            ...
            <form class="space-y-3 rounded border border-slate-200 bg-white p-4" @submit.prevent="submit">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="rounded bg-slate-900 px-3 py-2 text-sm text-white" :disabled="form.processing">Save and queue migration</button>
