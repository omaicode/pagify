...
use Pagify\PageBuilder\Webstudio\Services\TrpcService;

class TrpcController extends ApiController
{
	public function __invoke(Request $request, EditorAccessTokenService $editorAccessToken, SiteContext $siteContext, TrpcService $trpcService): JsonResponse
	{
